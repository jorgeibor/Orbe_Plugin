            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-default">
                    <div class="panel-config">
						<div id="row-config-familias">
							<span class="titleConf">Familias: </span>
							<select id="selectCategoria"></select>
							<input type="color" style="border: none;padding: 0;" id="famcolor" name="famcolor" value="#FFFFFF"/>
							<input type="text" id="hexcolor" style="width: 70px;" />
							<input name="resetColor" id="resetColor" value="Restablecer" type="button"/>
						</div>	
					</div>
					<input name="enviarConf" id="enviarConf" value="Guardar" type="button"/>
					<span id="msgCambios" name="msgCambios" style="display:none;"></span>
                </div>
    		</div>	
	<script>
		<?php
