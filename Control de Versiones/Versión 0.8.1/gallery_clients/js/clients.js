$(document).on('ready', function(){
	...
	$(document).on('click', '#divCategory h1', function(){
		...
		<!--console.log(idCategory);-->
			$.post("/orbevisualcom/wp-content/plugins/gallery_clients/admin/filters.php",{ idCategory : idCategory },function(clientes){
	...
	$(document).on('click', '.divClientsImage', function(){				   
		...
		$.post("/orbevisualcom/wp-content/plugins/gallery_clients/admin/lightboxDetails.php",{ idCliente : idCliente },function(tiposTrabajos){
	...
	$(document).on('click', '.jobCliente', function() {	   
		...
		//console.log(idJob);
		$.post("/orbevisualcom/wp-content/plugins/gallery_clients/admin/filters.php",{ idCategory : idJob },function(clientes){							
				console.log(clientes);
				if(clientes[0]['isNull'] == true){
